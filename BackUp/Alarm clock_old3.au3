...
Func MainGUI()
	...
	$MainGUI = GUICreate("Alarm clock", 476, 110, 444, 141)
...
Func AlarmState()
	Local $Stop = GUICtrlCreateButton("Stop", 264, 60, 112, 30)
	Local $Snooze = GUICtrlCreateButton("Snooze", 100, 60, 112, 30)
	GUICtrlDelete($CancelAlarm)
	$Alarm = "Alarm.wav"
	$msg = GUIGetMsg()
	...
	Select
		Case $msg = $Stop
			DllCall( "winmm.dll", "int", "mciExecute", "str", "stop " & $Alarm)
			GUICtrlDelete($Stop)
